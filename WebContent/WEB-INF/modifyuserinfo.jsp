...
<tr>
 ...
 <form action="${pageContext.request.contextPath }/modify.do" method="post">
  ...
  <tr>
    ...
    <td><input type="password" class="textinput" name="newPsw"/></td>
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;&nbsp;<input type="radio" name="msex" value="男" <c:if test="${user.usex=='男' }">checked="checked"</c:if> />
      男
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="msex" value="女" <c:if test="${user.usex=='女' }">checked="checked"</c:if>/>
女</td>
    </tr>
  <tr>
    <td style="text-align:right">电话：</td>
    <td colspan="2"><input name="m_tel" type="text" class="textinput" value="${user.uTel }"/></td>
  </tr>
  <tr>
    <td style="text-align:right">发货地址：</td>
    <td colspan="2"><input name="m_address" type="text" class="textinput" value="${user.uAddress }" style="width:350px"/></td>
    </tr>
  <tr>
    ...
    <td>&nbsp;</td>
		  ...
		  <table width="100%" border="0" cellspacing="2" class="upline">
            <tr>
              ...
              <td width="47%" style="width:50%"><select name="mquestion" class="textinput" style="width:230px; height:20px">
            ...
            <tr>
              ...
              <td colspan="2"><input name="manswer" type="text" class="textinput"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="#999999">不能少于4个字符，不区分大小写</font></td>
            </tr>
            <tr>
              <td style="text-align:right">备用邮箱：</td>
              <td><input name="mbackupemail" type="text" class="textinput"/></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td style="text-align:right">&nbsp;</td>
		  ...
		  <table width="100%" border="0" cellspacing="2" class="upline">
            <tr>
              ...
              <td style="width:25%"><input type="text" class="textinput" name="yzm" /></td>
              <td >&nbsp;<img id="img" src="${pageContext.request.contextPath }/codes.do"  /></td>
            </tr>
            <tr>
              <td style="text-align:right">&nbsp;</td>
              <td>&nbsp;</td>
		  ...
		  <p style="text-align:center"><input type="image" src="images/botton_gif_025.gif"  /></p>
