...
<table width="70%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td style="width:40%"><input type="text" class="textinput" name="uemail" id="umail"/></td>
    <td><img src="images/check_use.gif" width="111" height="24" id="check_unamil"/><span id="spmail"></span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="password" class="textinput" name="upsw"/></td>
    <td><font color="#999999">密码设置至少6位，请区分大小写</font></td>
  </tr>
  <tr>
    <td style="text-align:right">重复密码：</td>
    <td><input type="password" class="textinput" name="upswagain"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<option value="您的第一辆汽车或自行车是什么牌子的？" >您的第一辆汽车或自行车是什么牌子的？</option>
  ...
  <tr>
    ...
    <td><input type="text" class="textinput" name="ubackupemail"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
...
<table width="80%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td align="left"><img src="${pageContext.request.contextPath }/codes.do" id="img" /></td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
    <td>&nbsp;</td>
