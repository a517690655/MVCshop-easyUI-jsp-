                 ...
                 <c:forEach items="${cart }" var="good">
                  <table width="100%" border="0" cellspacing="0">
                    <tr>
                      ...
                      <c:set var="sum" value="${sum+good.ginprice*good.amount }"></c:set>
                      <td width="10%"><a href="${pageContext.request.contextPath }/cart.do?type=remove&gid=${good.gid}" style="color:#FF0000; font-weight:bold">X</a></td>
                    </tr>
                  </table>
                  </c:forEach>
				</c:if>
				   ...
				   <table cellspacing="1" class="carttable">
                     <tr>
                       <td style="text-align:right; padding-right:40px;"><font style="color:#FF6600; font-weight:bold">合计：&nbsp;&nbsp;${sum }元</font></td>
                      </tr>
                   </table>
				   <div style="text-align:right; margin-top:10px"><a href="${pageContext.request.contextPath }/list.do"><img src="${pageContext.request.contextPath }/images/gwc_jx.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/dispatcher.do?type=order"><img src="${pageContext.request.contextPath }/images/gwc_buy.gif" border="0" /></a></div>
