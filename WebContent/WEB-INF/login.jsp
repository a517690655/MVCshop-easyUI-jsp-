              ...
              <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="text-align:center"><table width="80%" border="0" cellspacing="0" style="margin-top:15px ;margin-left:auto; margin-right:auto">
                            ...
                            <tr>
                              <td colspan="2" style="text-align:center"><input type="checkbox" name="chk" value="checkbox" />
                                &nbsp;&nbsp;记住我的登录状态</td>
                            </tr>
                            <tr>
                              <td colspan="2" style="padding-top:10px; text-align:center">
                              	<input name="image" type="image"  src="${pageContext.request.contextPath }/images/loginbutton.gif"  />
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td colspan="2" style="padding-top:10px">
                              	<a href="${pageContext.request.contextPath }/dispatcher.do?type=register"><img src="${pageContext.request.contextPath }/images/loginline.gif" width="241" height="10" /></a>
                              </td>
                            </tr>
                            <tr>
                              <td colspan="2" style="padding-top:10px; text-align:center"><input name="image" type="image" src="${pageContext.request.contextPath }/images/signupbutton.gif" /></td>
                            </tr>
                        </table>
                        </td>
                      </tr>
                ...
                <td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
                  ...
                  <p style="text-align:right">
                    <a href="${pageContext.request.contextPath }/dispatcher.do?type=register"><input name="image" type="image" src="${pageContext.request.contextPath }/images/signupbutton.gif" /></a>
                  </p></td>
              </tr>
            </table>
          </div>
