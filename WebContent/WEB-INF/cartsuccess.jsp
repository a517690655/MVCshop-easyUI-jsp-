...
<div id="divhead">
  <table cellspacing="0" class="headtable">
    <tr>
      <td><a href="#"><img src="images/logo.gif" width="95" height="30" border="0" /></a></td>
      <td style="text-align:right"><img src="images/cart.gif" width="26" height="23" style="margin-bottom:-4px"/>&nbsp;<a href="#">购物车</a>　|　<a href="#">帮助中心</a>　|　<a href="my.html">我的帐户</a>　|　<a href="register.html">新用户注册</a></td>
    </tr>
  </table>
</div>

<div id="divmenu">
<a href="#">文学</a>　　<a href="#">生活</a>　　<a href="#">计算机</a>　　<a href="#">外语</a>　　<a href="#">经管</a>　　<a href="#">励志</a>　　<a href="#">社科</a>　　<a href="#">学术</a>　　<a href="#">少儿</a>　　<a href="#">艺术</a>　　<a href="product_list.html">原版</a>　　<a href="#">科技</a>　　<a href="#">考试</a>　　<a href="#">生活百科</a>　　　　<a href="#" style="color:#FFFF00">全部商品目录</a></div>
...
<a href="#"><img src="images/serchbutton.gif" border="0" style="margin-bottom:-4px"/></a></td>
  </tr>
</table>
        ...
        <tr>
          <td style="padding:20px; text-align:center"><table width="80%" border="0" cellspacing="0" style="margin-top:70px">
            <tr>
              ...
              <td style="padding-top:30px"><font style="font-weight:bold; color:#FF0000">已将商品添加到购物车当中.请点击返回</font><br />
                <br />
                <a href="${pageContext.request.contextPath }/index.do">返回首页</a></td>
            </tr>
          </table>          
            <p>&nbsp;</p>
            </td>
